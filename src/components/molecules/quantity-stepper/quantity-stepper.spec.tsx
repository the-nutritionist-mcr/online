...
test("Quantity steppers fires the onChange event with the incremented value if the plus button is clicked", async () => {
  const onChange = vi.fn();
...
test("Quantity stepper fires the onChange event with the decremented value if the decrease button is clicked", async () => {
  const onChange = vi.fn();
